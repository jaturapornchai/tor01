// Thailand Address Data - Complete 77 Provinces
...
export const thailandData: Province[] = [
  {
    "name": "กรุงเทพมหานคร",
    "districts": [
      {
...
export function getProvinces(): string[] {
  return thailandData.map(p => p.name);
}

export function getDistricts(provinceName: string): string[] {
  const province = thailandData.find(p => p.name === provinceName);
